 ...
 *  Each entry is a tuple of (Steam code, display label, ISO country code
 *  for the inline-SVG `FlagIcon` — "globe" for the all-languages entry).
 *  The order matches Playnite's `SteamLanguage.cs` enum. */
export const STEAM_LANGUAGES: { code: string; label: string; flag: string }[] = [
  { code: "all",        label: "All languages",          flag: "globe" },
  ...
  { code: "ukrainian",  label: "Українська",           flag: "ua" },
  { code: "german",     label: "Deutsch",                flag: "de" },
  { code: "french",     label: "Français",               flag: "fr" },
  { code: "italian",    label: "Italiano",               flag: "it" },
  { code: "spanish",    label: "Español (España)",       flag: "es" },
  { code: "latam",      label: "Español (Latinoamérica)", flag: "mx" },
  { code: "portuguese", label: "Português (Portugal)",   flag: "pt" },
  { code: "brazilian",  label: "Português (Brasil)",     flag: "br" },
  { code: "polish",     label: "Polski",                 flag: "pl" },
  { code: "czech",      label: "Čeština",                flag: "cz" },
  { code: "hungarian",  label: "Magyar",                 flag: "hu" },
  { code: "romanian",   label: "Română",                 flag: "ro" },
  { code: "bulgarian",  label: "Български",              flag: "bg" },
  { code: "greek",      label: "Ελληνικά",              flag: "gr" },
  { code: "turkish",    label: "Türkçe",                 flag: "tr" },
  { code: "thai",       label: "ไทย",                    flag: "th" },
  { code: "vietnamese", label: "Tiếng Việt",             flag: "vn" },
  { code: "indonesian", label: "Bahasa Indonesia",       flag: "id" },
  { code: "finnish",    label: "Suomi",                  flag: "fi" },
  { code: "swedish",    label: "Svenska",                flag: "se" },
  { code: "danish",     label: "Dansk",                  flag: "dk" },
  { code: "norwegian",  label: "Norsk",                  flag: "no" },
  { code: "dutch",      label: "Nederlands",             flag: "nl" },
];

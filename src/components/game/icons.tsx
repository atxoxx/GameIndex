...
/**
 * Newspaper glyph for the Game page's News tab. Two folded sheets
 * with a headline + body lines — reads as "news about this game"
 * next to the other Feather-style tab icons.
 */
export function IconNewspaper({ size, ...p }: IconProps) {
  return (
    <BaseIcon size={size} {...p}>
...
export function IconMaximize({ size, ...p }: IconProps) {
  return (
    <BaseIcon size={size} {...p}>
...
export function IconSteam({ size = 16, ...p }: IconProps) {
  return (
    <BaseIcon size={size} fill="currentColor" strokeWidth="0" {...p}>

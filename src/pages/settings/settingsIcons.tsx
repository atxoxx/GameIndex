/**
 * settingsIcons — every inline SVG used by the Settings page, extracted
 * from the former SettingsPage monolith so tab components can share them.
 * All stroke-based icons follow the project convention (24×24 viewBox,
 * stroke="currentColor", round caps/joins, fill="none"); brand marks
 * (Steam/Epic/GOG/Humble/Rockstar/Uplay) are fixed-color glyphs.
 */
...
export function GamepadIcon() {
  return (
    ...
    >
      ...
      <path d="M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.01-.098-.017-.152A4 4 0 0 0 17.32 5z" />
    </svg>
  );
}
...
/** Puzzle piece — the Plugins settings tab. */

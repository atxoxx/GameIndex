...
export function buildSettingsCatalog(t: (key: string, vars?: Record<string, unknown>) => string) {
  const meta: Record<SettingsTab, TabMeta> = {
    ...
    downloads: {
      ...
      keywords: "download save path speed limit sources debrid torrent",
      icon: <DownloadIcon />,
      sections: [
        {
          id: "downloads-location",
          labelKey: "settings.section.downloadLocation",
          keywords: "save path folder default always ask where downloads go",
          icon: <FolderIcon />,
        },
        {
          id: "downloads-notifications",
          labelKey: "settings.section.notifications",
          keywords: "notify notification toast desktop complete finish",
          icon: <BellIcon />,
        },
        {
          id: "downloads-bandwidth",
          labelKey: "settings.section.bandwidth",
          keywords: "speed limit download upload seed kbps disable upload bandwidth",
          icon: <GaugeIcon />,
        },
        {
          id: "downloads-blocked",
          labelKey: "settings.section.blockedDomains",
          keywords: "block domain filter blacklist tracker source blocklist",
          icon: <ShieldIcon />,
        },
        {
          id: "downloads-sources",
          labelKey: "settings.section.downloadSources",
          keywords: "sources hydra json mirrors url source manager",
          icon: <ListIcon />,
        },
        {
          id: "downloads-debrid",
          labelKey: "settings.section.debrid",
          keywords: "debrid alldebrid torbox api key token magnet direct download",
          icon: <CloudIcon />,
        },
      ],
    },

...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![get_platform, scan_folder_for_exes, scan_folders_for_exes, cancel_scan_exes, launch_game, force_close_game, launch_splash::open_launch_splash, launch_splash::update_launch_splash_status, launch_splash::get_launch_splash_state, launch_splash::show_launch_splash_window, launch_splash::retry_launch_splash, launch_splash::close_launch_splash, save_games, save_games_subset, save_game, load_games, close_splashscreen, update_game_last_played, read_cover_image, search_game_metadata, get_igdb_game_by_id, fetch_hltb_stats, get_steam_tags, fetch_game_images, download_image, download_artwork, store_artwork_file, artwork_asset_url, cleanup_artwork_cache, search_launchbox_images, detect_gpus, list_media_files, save_screenshot, save_text_file, load_sessions, get_sessions, delete_session, delete_sessions_for_game, relink_sessions_for_game, insert_session, load_game_notes, save_game_note, delete_game_note, delete_game_notes_for_game, get_system_ram_gb, get_system_info, refresh_hardware, set_metrics_config, detect_game_size, check_paths_exist, open_folder, disk_usage, resolve_mounts, move_game_install, uninstall_game, measure_path_size, detect_steam_screenshot_folders, detect_system_screenshot_folders, save_store_cache, load_store_cache, fetch_store_games, fetch_spotlight_games, search_store_games, get_igdb_platforms,            get_store_game_detail, get_collection_games,            fetch_game_reviews, fetch_external_reviews, get_recommended_config, get_steam_page_features,
        ...
        .setup(|app| {
            ...
            // Snapshot mirrored into the standalone launch splash window
            // (see `launch_splash`). Managed here so the commands can read
            // it through `tauri::State`.
            app.manage(launch_splash::LaunchSplashState::default());
